...
import { Mail, Lock, ArrowRight, Eye, EyeOff, Loader2, Compass } from "lucide-react";
      ...
      >
        <div className="bg-white/80 dark:bg-[#09090a]/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-gray-150 dark:border-gray-850">
          ...
          <div className="flex bg-gray-100 dark:bg-black/50 p-1.5 rounded-2xl mb-8">
            <Link href="/login" className="flex-1 py-3 text-center text-sm font-bold rounded-xl bg-white dark:bg-[#1a1a1c] text-red-600 dark:text-red-500 shadow-sm transition-all">
              Вход
            </Link>
            <Link href="/register" className="flex-1 py-3 text-center text-sm font-bold rounded-xl text-gray-500 hover:text-black dark:hover:text-white transition-all">
              Регистрация
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-12 pr-4 bg-gray-50 dark:bg-black/30 border border-gray-200 dark:border-gray-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-550 transition-all text-sm font-medium"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs font-bold text-red-600 dark:text-red-500 hover:underline cursor-pointer">
                  Забыли пароль?
                </span>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-12 pr-12 bg-gray-50 dark:bg-black/30 border border-gray-200 dark:border-gray-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-550 transition-all text-sm font-medium"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 pt-6 border-t border-gray-150 dark:border-gray-850 text-center">
            <p className="text-[11px] text-gray-450 leading-relaxed">
              Администратор? Войдите с email <code className="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-850 font-mono text-[10px] text-red-500">admin@changan.am</code>
            </p>
          </div>
